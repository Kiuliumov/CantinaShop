(function () {
  ...
  function addMessage({ text, username, avatarUrl, timestamp, fromAdmin }) {
    ...
    avatar.src = avatarUrl || '/static/images/avatar.png';
    avatar.alt = username;
    ...
    try {
      ...
      recentMessages.forEach(msg => {
        addMessageSafe({
          ...
          avatarUrl: (msg.sender_id === 0 || msg.from_admin) ? adminAvatarUrl : (msg.avatar_url || '/static/images/avatar.png'),
  ...
  function connectSocket(userId) {
    ...
    chatSocket.onmessage = (e) => {
      ...
      addMessageSafe({
        ...
        avatarUrl: fromAdmin ? adminAvatarUrl : (data.avatar_url || '/static/images/avatar.png'),
